const translations = {
  ko: {
    'nav.status': '매장 현황', 'nav.lineup': '라인업', 'nav.menu': '주류 안내', 'nav.space': '공간', 'nav.location': '오시는 길',
    'common.call': '전화 문의',
  ...
  zh: {
    'nav.status': '店铺现况', 'nav.lineup': '阵容', 'nav.menu': '酒水价格', 'nav.space': '空间', 'nav.location': '交通位置',
    'common.call': '电话咨询',
  ...
  ja: {
    'nav.status': '店舗状況', 'nav.lineup': 'ラインアップ', 'nav.menu': '酒類案内', 'nav.space': '空間', 'nav.location': 'アクセス',
    'common.call': '電話で相談',
