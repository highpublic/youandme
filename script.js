const translations = {
  ko: {
    ...
    'faq.eyebrow': 'FAQ', 'faq.title': '자주 묻는 질문', 'faq.desc': '처음 문의하시는 분들도 바로 이해할 수 있도록 핵심만 정리했습니다.', 'faq.q1': '하이퍼블릭이란 정확히 무엇인가요?', 'faq.a1': '하이퍼블릭은 퍼블릭에서 발전한 상위 형태의 엔터테인먼트로, 독립 공간 기반의 즉석 선택이 핵심입니다. 퍼블릭의 빠른 진행과 룸싸롱의 프라이빗함이 결합된 구조입니다.', 'faq.q2': '강남하이퍼블릭과 일반 하이퍼블릭의 차이는?', 'faq.a2': '강남하이퍼블릭은 강남 지역 특성상 외모 수준, 서비스 품질, 프리미엄 분위기가 한층 강합니다. 업소별 스타일 분화도 더 뚜렷하며, 선택 폭이 넓은 것이 특징입니다.', 'faq.q3': '예약 없이 당일 방문 가능한가요?', 'faq.a3': '당일 문의 후 입장이 가능한 경우가 많습니다. 다만 주말이나 심야 시간대는 사전 문의가 유리하며, 대기 여부를 미리 확인하는 것을 권장합니다.', 'faq.q4': '혼자 방문해도 되나요?', 'faq.a4': '네, 1:1 매칭 구조이므로 단독 방문도 전혀 문제없습니다. 단독 고객 비율도 상당히 높은 편이며, 부담 없이 이용 가능합니다.', 'faq.q5': '강남하이퍼블릭 요금 체계는 어떻게 되나요?', 'faq.a5': '업소마다 다르지만 일반적으로 주대와 60분 단위 이용 요금으로 구성됩니다. 웹 예약 이벤트 시 할인이 적용될 수 있으며, 정확한 요금은 전담 채널을 통해 확인 가능합니다.', 'faq.q6': '강남하이퍼블릭 이용 시 주의사항은?', 'faq.a6': '과도한 음주는 자제하시고, 업소 내 규정을 준수해 주세요. 예약 시간을 지키는 것이 원활한 진행에 도움이 되며, 문의 시 정확한 정보를 전달할수록 더 나은 서비스를 받을 수 있습니다.',    'booking.eyebrow': 'Reservation Guide', 'booking.title': '문의 전 이것만 정하면 예약이 빨라집니다', 'booking.desc': '인원, 방문 시간, 원하는 분위기만 알려주시면 현재 라인업과 룸 상황 기준으로 가장 편한 구성을 안내드립니다.', 'booking.step1': '인원 확인', 'booking.step1Desc': '1인 방문부터 단체 모임까지 인원에 맞는 룸과 구성을 먼저 확인합니다.', 'booking.step2': '시간대 선택', 'booking.step2Desc': '이벤트, 1부, 2부 중 예산과 분위기에 맞는 시간대를 추천드립니다.', 'booking.step3': '가격 확인', 'booking.step3Desc': '정찰제 기준으로 주대, 티씨, RT&WT를 방문 전 먼저 안내합니다.', 'booking.step4': '예약 확정', 'booking.step4Desc': '도착 전 룸 배정과 입장 동선을 정리해 처음 방문도 편하게 안내합니다.', 'booking.trust1': '방문 전 가격 확인', 'booking.trust2': '당일 상황 반영', 'booking.trust3': '1인·단체 모두 상담', 'booking.trust4': '24시간 문의 가능', 'booking.ctaTitle': '지금 가능한 시간과 예산을 먼저 확인하세요.', 'booking.ctaBody': '전화 한 번으로 대기 상황, 추천 시간대, 예상 비용까지 빠르게 안내드립니다.', 'booking.ctaPrimary': '예약 상담 연결', 'booking.ctaSecondary': '가격표 보기', 'sticky.copy': '방문 전 가격·룸·라인업 확인', 'sticky.cta': '예약 상담',
  ...
  zh: {
    ...
    'faq.eyebrow': 'FAQ', 'faq.title': '常见问题', 'faq.desc': '为首次咨询的客人整理了最容易理解的核心内容。', 'faq.q1': 'Highpublic到底是什么？', 'faq.a1': 'Highpublic 是从 Public 发展而来的上位娱乐形式，核心是独立空间和现场选择。它结合了 Public 的快速流程和包间沙龙的私密性。', 'faq.q2': '江南Highpublic和普通Highpublic有什么区别？', 'faq.a2': '江南Highpublic因地区特性，在外貌水平、服务品质和高级氛围方面更强。各店风格区分更明显，选择范围也更宽。', 'faq.q3': '没有预约也可以当天到访吗？', 'faq.a3': '多数情况下当天咨询后可以入场。不过周末或深夜时段建议提前咨询，并先确认等待情况。', 'faq.q4': '一个人也可以去吗？', 'faq.a4': '可以。由于是1:1匹配结构，单独到访完全没有问题。单人客人比例也相当高，可以轻松使用。', 'faq.q5': '江南Highpublic费用体系是怎样的？', 'faq.a5': '各店会有差异，但一般由酒水基本费用和60分钟单位使用费用组成。通过网页预约活动可能适用优惠，准确价格可通过专属咨询渠道确认。', 'faq.q6': '使用江南Highpublic时需要注意什么？', 'faq.a6': '请避免过度饮酒并遵守店内规定。准时到达有助于顺利进行，咨询时提供越准确的信息，就能获得更合适的服务。',    'booking.eyebrow': 'Reservation Guide', 'booking.title': '咨询前只需先确认这几项', 'booking.desc': '告诉我们人数、到访时间和想要的氛围后，会根据当前阵容和包间情况推荐合适方案。', 'booking.step1': '确认人数', 'booking.step1Desc': '从单人到团体聚会，先确认适合人数的包间和配置。', 'booking.step2': '选择时段', 'booking.step2Desc': '在活动、第一场、第二场中，根据预算和氛围推荐合适时间。', 'booking.step3': '确认价格', 'booking.step3Desc': '按照明码价格，提前说明酒水、TC、RT&WT等费用。', 'booking.step4': '确认预约', 'booking.step4Desc': '到达前整理包间安排和入场动线，首次到访也能轻松使用。', 'booking.trust1': '到访前确认价格', 'booking.trust2': '反映当天情况', 'booking.trust3': '单人·团体均可咨询', 'booking.trust4': '24小时可咨询', 'booking.ctaTitle': '先确认当前可预约时间和预算。', 'booking.ctaBody': '通过电话快速确认等待情况、推荐时段和预计费用。', 'booking.ctaPrimary': '预约咨询', 'booking.ctaSecondary': '查看价格', 'sticky.copy': '到访前确认价格·包间·阵容', 'sticky.cta': '预约咨询',
  ...
  ja: {
    ...
    'faq.eyebrow': 'FAQ', 'faq.title': 'よくある質問', 'faq.desc': '初めてお問い合わせの方にも分かりやすいよう、要点だけ整理しました。', 'faq.q1': 'ハイパブリックとは正確に何ですか？', 'faq.a1': 'ハイパブリックはパブリックから発展した上位形態のエンターテインメントで、独立空間を基盤にした即時選択が核心です。パブリックの早い進行とルームサロンのプライベート感を組み合わせた構造です。', 'faq.q2': '江南ハイパブリックと一般的なハイパブリックの違いは？', 'faq.a2': '江南ハイパブリックは地域特性上、外見レベル、サービス品質、プレミアムな雰囲気がより強い傾向があります。店舗ごとのスタイル分化も明確で、選択肢が広いのが特徴です。', 'faq.q3': '予約なしで当日訪問できますか？', 'faq.a3': '当日お問い合わせ後に入場できる場合が多いです。ただし週末や深夜帯は事前相談が有利で、待機状況を先に確認することをおすすめします。', 'faq.q4': '一人で訪問しても大丈夫ですか？', 'faq.a4': 'はい、1:1マッチング構造のため単独訪問もまったく問題ありません。単独のお客様も多く、気軽にご利用いただけます。', 'faq.q5': '江南ハイパブリックの料金体系は？', 'faq.a5': '店舗によって異なりますが、一般的には酒代と60分単位の利用料金で構成されます。Web予約イベント時は割引が適用される場合があり、正確な料金は専用窓口で確認できます。', 'faq.q6': '利用時の注意事項は？', 'faq.a6': '過度な飲酒は控え、店内規定を守ってください。予約時間を守ると進行がスムーズになり、問い合わせ時に正確な情報を伝えるほど、より適した案内を受けられます。',    'booking.eyebrow': 'Reservation Guide', 'booking.title': 'お問い合わせ前に決めるのはこれだけ', 'booking.desc': '人数、来店時間、希望の雰囲気をお伝えいただければ、現在のラインアップとルーム状況に合わせてご案内します。', 'booking.step1': '人数確認', 'booking.step1Desc': '1名様から団体まで、人数に合うルームと構成を先に確認します。', 'booking.step2': '時間帯選択', 'booking.step2Desc': 'イベント、1部、2部の中から予算と雰囲気に合う時間帯をご提案します。', 'booking.step3': '料金確認', 'booking.step3Desc': '定額料金を基準に、酒代、TC、RT&WTを来店前にご案内します。', 'booking.step4': '予約確定', 'booking.step4Desc': '到着前にルーム配置と入場導線を整え、初めてでもスムーズにご案内します。', 'booking.trust1': '来店前に料金確認', 'booking.trust2': '当日の状況を反映', 'booking.trust3': '1名・団体どちらも相談可', 'booking.trust4': '24時間お問い合わせ可能', 'booking.ctaTitle': '今空いている時間と予算を先に確認しましょう。', 'booking.ctaBody': '電話で待機状況、おすすめ時間帯、予想費用まで素早くご案内します。', 'booking.ctaPrimary': '予約相談', 'booking.ctaSecondary': '料金表を見る', 'sticky.copy': '来店前に料金・ルーム・ラインアップ確認', 'sticky.cta': '予約相談',
